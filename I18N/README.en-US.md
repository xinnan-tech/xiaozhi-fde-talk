...
[Quick Start](#quick-start) · [WebSocket Protocol](../docs/websocket-protocol.md) · [HTTP API](../docs/http-api.md) · [Report an issue](https://github.com/xinnan-tech/xiaozhi-fde-talk/issues)
...
The backend defaults its ASR URL to `wss://localhost:10096`, provided by the system config `asr.ws_url` (seeded automatically on first run). It is not configured in `.env`—local development works out of the box.
